...
public class StaticBD {
	...
	static {
		...
		pagamentos.add(new Pagamento(7, "Celular", LocalDate.now(), 190.00, false));
		pagamentos.add(new Pagamento(8, "Netflix", LocalDate.of(2020, 11, 15), 60.00, false));
	}
